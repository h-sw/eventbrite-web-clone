...
module.exports = function(passport) {
  ...
  passport.use('kakao-login', new KakaoStrategy({
    clientID: '27b886ceb30f5a886db6df284c796310',
    clientSecret: '5KVnznPqcdHrOryxYhEJZvv4zNqxgnbJ',
    callbackURL: 'https://nameless-ravine-28238.herokuapp.com/oauth/kakao/callback'
},
async (accessToken, refreshToken, profile, done) => {
    ...
    try {
      ...
      if (!user) {
        ...
        if (!user) {
          ...
          user.email =  email ? email : `${profile.id}@no-email.com`;
        }
  ...
  passport.use(new FacebookStrategy({
    ...
    clientID : '879320092231931',
    clientSecret : '7910083c059efddddb55d11555ab2954',
    callbackURL : 'https://nameless-ravine-28238.herokuapp.com/auth/facebook/callback',
